...
```
[1] "/Users/nick/github/njtierney/explore-quarto-directories"
```
...
```{.r .cell-code}
read_csv("first/secondstorms.csv")
```

::: {.cell-output .cell-output-error}

```
Error: 'first/secondstorms.csv' does not exist in current working directory ('/Users/nick/github/njtierney/explore-quarto-directories').
```
